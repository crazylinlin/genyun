...
module.exports = "<div class=\"container header-wrap\">\n\t<span class=\"head-title\">耕耘课堂</span>\n\t<span class=\"search-wrap\">\n\t\t<input type=\"text\" placeholder=\"\"/>\n\t\t<a href=\"javascript:void(0);\" id=\"btn-search\">\n\t\t\t<i class=\"glyphicon glyphicon-search\"></i>\n\t\t</a>\n\t</span>\n\t<span class=\"link-control\">\n\t\t<a href=\"javascript:void(0);\" id=\"login\" data-role=\"login\">登录</a>\n\t\t<a href=\"javascript:void(0)\" id=\"register\" data-role=\"register\">注册</a>\n\t</span>\n\t<!--<div class=\"login-info\">\n\t\t<a href=\"#\" class=\"img-wrap\">\n\t\t\t<img src=\"/images/ll001.jpg\" class=\"img-circle\" width=\"48px\" height=\"48px\" alt=\"图片\"/>\n\t\t\t<span class=\"name\">天空上的美人鱼</span>\n\t\t\t<span class=\"caret\"></span>\n\t\t</a>\n\t\t<ul class=\"links-wrap\">\n\t\t\t<li><i class=\"fa fa-book\"></i><a href=\"#\">我的课程</a></li>\n\t\t\t<li><i class=\"fa fa-money\"></i><a href=\"#\">我的钱包</a></li>\n\t\t\t<li><i class=\"fa fa-pagelines\"></i><a href=\"#\">成为讲师</a></li>\n\t\t\t<li><i class=\"fa fa-user-circle-o\"></i><a href=\"#\">个人信息</a></li>\n\t\t\t<li><i class=\"fa fa-pencil-square-o\"></i><a href=\"#\">意见反馈</a></li>\n\t\t\t<li><i class=\"fa fa-refresh\"></i><a href=\"#\">帐号切换</a></li>\n\t\t</ul>\n\t</div>-->\n</div>";
...
module.exports = "<div class=\"dialog\" id=\"qrCode-pay\">\n\t<h4 class=\"dialog-title text-right\">\n\t\t<a href=\"javascript:void(0);\" class=\"close-btn text-center\">\n\t\t\t<i class=\"glyphicon glyphicon-remove\"></i>\n\t\t</a>\n\t</h4>\n\t<div class=\"qr-dialog-wrap\">\n\t\t<div class=\"dialog-content\">\n\t\t\t<div class=\"qrCode-wrap\">\n\t\t\t\t<h5 class=\"text-center\">\n\t\t\t\t\t支付金额：\n\t\t\t\t\t<span id=\"show-money\">\n\t\t\t\t\t\t<i class=\"glyphicon glyphicon-jpy\"></i>\n\t\t\t\t\t\t<span id=\"pay-money\">9999元</span>\n\t\t\t\t\t</span>\n\t\t\t\t</h5>\n\t\t\t\t<div class=\"code-wrap text-center\">\n\t\t\t\t\t<img src=\"/images/qrcode001.jpg\" id=\"qrCode-img\" alt=\"二维码\"/>\n\t\t\t\t\t<p class=\"pay-notice\">请使用手机微信扫描二维码进行支付</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</div>";
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js??ref--0-1!../../../../../node_modules/postcss-loader/index.js??ref--0-2!./bootstrap-theme.min.css", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js??ref--0-1!../../../../../node_modules/postcss-loader/index.js??ref--0-2!./bootstrap-theme.min.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../../../node_modules/css-loader/index.js??ref--0-1!../../../../../node_modules/postcss-loader/index.js??ref--0-2!./bootstrap.min.css", function() {
			var newContent = require("!!../../../../../node_modules/css-loader/index.js??ref--0-1!../../../../../node_modules/postcss-loader/index.js??ref--0-2!./bootstrap.min.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
var _loginAndReg = __webpack_require__(19);

var _loginAndReg2 = _interopRequireDefault(_loginAndReg);
...
(0, _jqueryMin2.default)(document).ready(function () {
	...
	(0, _jqueryMin2.default)("#header").html(_header2.default);
	/*end 添加尾部*/
	/*start 添加登录以及注册对话框*/
	(0, _jqueryMin2.default)("#dialog-container").html(_loginAndReg2.default);
	/*end 添加登陆一集注册对话框*/
	...
	(0, _jqueryMin2.default)(document).delegate(".close-btn", "click", function () {
		layer.close(window.index);
	});
	/*end 右上角关闭按钮事件，点击关闭模态框*/
	/*start 当页面需要二维码支付时导入二维码组件*/
	//codePay-container 为容器id
	(0, _jqueryMin2.default)("#codePay-container").html(_qrCode2.default);
 ...
 /*start 当页面需要生成订单页面时导入订单组件*/
	...
	/*start 支付方式选择*/
	(0, _jqueryMin2.default)(document).delegate(".pay-type", "change", function () {
		var $this = (0, _jqueryMin2.default)(this),
	...
	/*end 支付方式选择*/
	/*start 忘记密码*/
	(0, _jqueryMin2.default)(document).delegate("#forget-password", "click", function () {
		layer.close(window.index);
		window.index = layer.open({
			type: 1,
			title: false,
			closeBtn: 0,
			shadeClose: true,
			content: (0, _jqueryMin2.default)('#find-password'),
			skin: "",
			area: ['604px', '380px'],
			success: function success(layero, index) {
				...
				(0, _jqueryMin2.default)("div#find-password").css("display", "none");
			}
		});
	});
	/*end   忘记密码*/
